...
public class DemoModel {
    ...
    public boolean updateContactList(List<EaseUser> contactList) {
        ...
        EmUserDao dao = DemoDbHelper.getInstance(EaseIMHelper.getInstance().getApplication()).getUserDao();
        if(dao != null) {
    ...
    public List<AppKeyEntity> getAppKeys() {
        AppKeyDao dao = DemoDbHelper.getInstance(EaseIMHelper.getInstance().getApplication()).getAppKeyDao();
        if(dao == null) {
    ...
    public DemoDbHelper getDbHelper() {
        return DemoDbHelper.getInstance(EaseIMHelper.getInstance().getApplication());
    }
