...
public class BaseEMRepository {
     ...
     */
    public void initDb() {
        DemoDbHelper.getInstance(getContext()).initDb(getCurrentUser());
    }
    ...
    public EmUserDao getUserDao() {
        return DemoDbHelper.getInstance(getContext()).getUserDao();
    }
    ...
    public MsgTypeManageDao getMsgTypeManageDao() {
        return DemoDbHelper.getInstance(getContext()).getMsgTypeManageDao();
    }
    ...
    public InviteMessageDao getInviteMessageDao() {
        return DemoDbHelper.getInstance(getContext()).getInviteMessageDao();
    }
